  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0d1117', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div style={{ maxWidth: 920, margin: '0 auto', padding: '36px 24px' }}>
        <div className="sk" style={{ height: 80, borderRadius: 12, marginBottom: 20 }} />
        <div className="sk" style={{ height: 280, borderRadius: 20, marginBottom: 24 }} />
        <div className="sk" style={{ height: 300, borderRadius: 16, marginBottom: 24 }} />
